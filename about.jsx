    ...
    <div className="developers-container">
      ...
      <div className="developer-card">
        ...
        <div className="developer-info">
          ...
          <p className="description">
            ...
            metus eget felis placerat eleifend. Aenean vel sapien eu nulla
            consequat vestibulum.
          </p>
          <div className="social-links">
            <a
              href="https://github.com/Arunsiva003"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/arun2003as"
              target="_blank"
              rel="noopener noreferrer"
            >
              LinkedIn
      ...
      <div className="developer-card">
        ...
        <div className="developer-info">
          ...
          <p className="description">
            Sed suscipit risus et vulputate congue. Morbi sit amet sagittis
            magna. Suspendisse ac est libero. Vestibulum ante ipsum primis in
            faucibus orci luctus et ultrices posuere cubilia curae.
          </p>
          <div className="social-links">
            <a
              href="https://github.com/Sameerul-Hak"
              target="_blank"
              rel="noopener noreferrer"
            >
              Github
            ...
            <a
              href="https://www.linkedin.com/in/sameerul-hak-877194249/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Linkedin
